...
const EditCategory = ({data}) => {
    ...
    const [categoryy, setCategoryy] = useState(data?.category || '');
    ...
    return (
        ...
        <div className="text-center text-white bg-black p-2 mb-4 rounded-t-md">
          <h1>Edit new product category</h1>
        </div>
              ...
              <div className="flex flex-col">
                <div className="flex justify-end">
                  <FontAwesomeIcon
                    ...
                    className=" mb-[-40px] w-3 h-3 p-1 bg-red-500 rounded-full text-2xl text-white font-bold z-10 cursor-pointer"
                    icon={faX}
                  />
                </div>
